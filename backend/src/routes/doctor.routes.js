...
router.get("/", auth_1.authenticate, (0, auth_1.authorize)("ADMIN", "DOCTOR"), doctor_controller_1.getDoctors);
router.get("/:id", auth_1.authenticate, (0, auth_1.authorize)("ADMIN", "DOCTOR"), doctor_controller_1.getDoctorById);
