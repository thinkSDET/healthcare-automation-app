...
export declare const updateOrderStatus: (orderId: number, status: "PENDING" | "CONFIRMED" | "PROCESSING" | "SHIPPED" | "DELIVERED" | "CANCELLED") => Promise<{
    items: {
        id: number;
        orderId: number;
        productName: string;
...
export declare const updatePaymentStatus: (orderId: number, paymentStatus: "PENDING" | "PAID" | "FAILED" | "REFUNDED") => Promise<{
    items: {
        id: number;
        orderId: number;
        productName: string;
